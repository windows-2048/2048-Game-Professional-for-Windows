...
void MainWindow::ctor()
{
    ...
    setWindowTitle(tr("2048 Game Professional (formerly 2048 Game Girls Choice With Kitties)"));
...
void MainWindow::onTriggeredAbout()
{
    ...
    msgBox.setText(tr("<font color='#fd97a2'><b>2048 Game Professional</b></font>,<br/>formerly <font color='#ac8691'><b>2048 Game Girls Choice With Kitties For Windows Desktop</b></font>,<br/>version <b>%1</b> built with icl,<br/>build %2 - %3.<br/><br/>Visit our&nbsp;site:<br/>%4.<br/><br/>Donate bitcoins to 1BwbHouqfwscPMXar9dNQ3oQfgRhA1kLfh.<br/><br/><img align='right' src=':/MainWindow/Resources/bitcoin_qrcode.png'/>").arg(strVer).arg(__DATE__).arg(__TIME__).arg(strHomeM));
