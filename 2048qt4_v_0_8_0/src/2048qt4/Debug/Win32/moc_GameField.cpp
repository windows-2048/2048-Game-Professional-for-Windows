...
static const char qt_meta_stringdata_GameField[] = {
    "GameField\0\0fieldChanged(int)\0updateGame()\0"
    "newGame()\0"
};
...
void GameField::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->fieldChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
...
const QMetaObject GameField::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_GameField,
...
// SIGNAL 0
void GameField::fieldChanged(int _t1)
{
